    ...
    <div className="border border-neutral-200 rounded-md bg-neutral-50/60 px-4 py-2.5 mt-2">
      <div className="flex items-center gap-2 mb-1.5">
        <span className="text-[11px] font-medium text-neutral-500">
          {cityName} — latest news
        </span>
        <span className="text-[10px] text-neutral-400">· refreshes daily at 7am Bogotá</span>
      </div>
      ...
      {!loading && !error && (
        <>
          {items.length === 0 && (
            <span className="text-[11px] text-neutral-400">No relevant news today</span>
          )}
