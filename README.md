...
- [x] Fase 2 (parcial): festivos ahora se consultan **en vivo** desde [Nager.Date](https://date.nager.at) (API pública, sin key) en vez de una tabla fija — cubre los 6 países, incluyendo Ecuador (que la fuente interna de DiDi no tenía). Si la API falla, cae a un cálculo algorítmico local y lo avisa en pantalla.
  - Eventos deportivos: investigado y **descartado por ahora**. TheSportsDB (llave gratis compartida) está saturada globalmente y no es confiable. API-Football (llave personal gratis, ya la tenemos) resultó tener el plan free limitado a temporadas históricas 2021-2023 — sin partidos actuales ni futuros, inútil para este caso de uso. Retomar cuando aparezca una fuente gratuita real, o evaluar un plan pago.
  - School Break / Back to School agregado para todas las ciudades CASA (Bogotá, Cali, Pereira, Bucaramanga, Lima, Valparaíso, Región Metropolitana, Concepción, San José, Quito), tomado de fuentes oficiales: MEN Colombia, Minedu Perú, Mineduc Chile, MEP Costa Rica, Ministerio de Educación Ecuador (cada evento tiene `source_url` en la base de datos). Barranquilla usa Calendario B en Colombia, cuyas fechas oficiales 2026 aún no estaban publicadas al momento de esta investigación — queda pendiente.
  - Pendiente: eventos propios (conciertos/high-demand) para Hermosillo, Cali, Pereira, Bucaramanga, Barranquilla, Concepción, Región Metropolitana, San José y Quito — solo tienen festivos + calendario escolar, no conciertos/ferias locales
